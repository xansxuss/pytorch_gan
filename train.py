...
train_set = datasets.MNIST(
    root=r'D:\program file\pyw\data\mnist', train=True, download=True, transform=transform)
test_set = datasets.MNIST(root=r'D:\program file\pyw\data\mnist', train=False,
    ...
    for times, data in enumerate(train_loader):
        ...
        if times % 100 == 0 or times == len(train_loader):
            print('[{}/{}, {}/{}] D_loss: {:.3f} G_loss: {:.3f}'.format(epoch,
                  epochs, times, len(train_loader), d_loss.item(), g_loss.item()))
